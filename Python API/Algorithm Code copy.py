...
def select_image():
    ...
    path = "C:/Users/abhim/OneDrive/Documents/S9 Mini Project files/fake-currency-detection-mobile-app/Fake Currency Detection Jupyter/Fake Notes/500/500_f4.jpg"
    ...
    def testFeature_1_2_7():
        ...
        for j in range(NUM_OF_FEATURES):
            ...
            for i in range(NUMBER_OF_TEMPLATES):
                ...
                # Current template 
                cur_dir = os.getcwd()
                template_path ="C:\\Users\\abhim" + '\\S9 Mini Project files\\New\\Dataset\\100_Features Dataset\\Feature ' + str(j+1) + '\\' + str(i+1) + '.jpg'
